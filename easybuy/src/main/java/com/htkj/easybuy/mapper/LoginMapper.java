...
public interface LoginMapper {
    ...
    Login login(@Param("mobile") String mobile, @Param("password") String password);
    ...
    Login getMobile(@Param("mobile") String mobile);
    ...
    int addUser(@Param("loginUser") Login loginUser);
}
